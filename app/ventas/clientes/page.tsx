...
const CLIENTES: Cliente[] = [
  { codigo: 'CL002214', nombre: 'BANCO DE DESARROLLO DE LA REPUBLICA DE EL SALVADOR', ciudad: 'San Salvador', satisfaccion: 'muy_satisfecho', diasSinContacto: 4, ultimaGestion: '2026-06-28' },
  { codigo: 'CL002215', nombre: 'FONDO DE DESARROLLO ECONOMICO', ciudad: 'San Salvador', satisfaccion: 'satisfecho', diasSinContacto: 7, ultimaGestion: '2026-06-25' },
  { codigo: 'CL002216', nombre: 'FONDO SALVADORENO DE GARANTIAS', ciudad: 'San Salvador', satisfaccion: 'neutral', diasSinContacto: 3, ultimaGestion: '2026-06-29' },
  { codigo: 'CL003287', nombre: 'INVERSIONES TOTALES, S.A. DE C.V.', ciudad: 'San Salvador', satisfaccion: 'muy_satisfecho', diasSinContacto: 6, ultimaGestion: '2026-06-26' },
  { codigo: 'CL003289', nombre: 'MINISTERIO DE DESARROLLO LOCAL', ciudad: 'San Salvador', satisfaccion: 'satisfecho', diasSinContacto: 17, ultimaGestion: '2026-06-15' },
  { codigo: 'CL003342', nombre: 'P.S. LA ESPERANZA, S.A. DE C.V.', ciudad: 'San Salvador', satisfaccion: 'insatisfecho', diasSinContacto: 1, ultimaGestion: '2026-07-01' },
  { codigo: 'CL003354', nombre: 'DEVEL SECURITY, S.A. DE C.V.', ciudad: 'Antiguo Cuscatlan', satisfaccion: 'satisfecho', diasSinContacto: 2, ultimaGestion: '2026-06-30' },
  { codigo: 'CL003376', nombre: 'CAJA DE CREDITO Y AHORRO DE SAN JUAN OPICO', ciudad: 'San Juan Opico', satisfaccion: 'neutral', diasSinContacto: 35, ultimaGestion: '2026-05-28' },
  { codigo: 'CL003401', nombre: 'COMERCIALIZADORA DEL PACIFICO, S.A. DE C.V.', ciudad: 'Soyapango', satisfaccion: 'muy_satisfecho', diasSinContacto: 3, ultimaGestion: '2026-06-29' },
  { codigo: 'CL003422', nombre: 'INDUSTRIAS METALURGICAS UNIDAS, S.A. DE C.V.', ciudad: 'Ilopango', satisfaccion: 'satisfecho', diasSinContacto: 5, ultimaGestion: '2026-06-27' },
];
                  ...
                  filtered.map((c, idx) => (
                    <tr key={c.codigo} className="border-t border-[#EEEEEC] hover:bg-[#F5F5ED]/40">
                      ...
                      <td className="px-5 py-3 text-xs">
                        <span className="text-[#0c6aa1] font-mono font-medium">{c.codigo}</span>
                      </td>
