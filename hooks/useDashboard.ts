      ...
      if (filters.asesor) {
        ...
        result = {
          metricas: {
            ...
            leads_no_agendados: m.leads_no_agendados || 0,
            total_equipos: m.total_equipos || 0,
            atendidos_por_asesor: m.atendidos_por_asesor || 0,
            atendidos_por_lider: m.atendidos_por_lider || 0,
            atendidos_por_gerente: m.atendidos_por_gerente || 0,
          },
          resumen: {
            lead_no_calificado: m.leads_no_agendados || 0,
            lead_calificado: m.leads_aceptados || 0,
            total_comercial: m.atendidos_por_asesor || 0,
            total_lider: m.atendidos_por_lider || 0,
            total_gerencial: m.atendidos_por_gerente || 0,
            atendidos_por_asesor: m.atendidos_por_asesor || 0,
            atendidos_por_lider: m.atendidos_por_lider || 0,
            atendidos_por_gerente: m.atendidos_por_gerente || 0,
          },
